    ...
    <div>
      <header className="flex h-[65px] px-[56px] justify-between items-center sticky top-0 z-50 bg-white">
        <div className="flex w-[152px] gap-2">
          <div>
            <img
              src="https://imagedeleg1.lacoste.com/dw/image/v2/BGSW_PRD/on/demandware.static/Sites-ID-Site/-/default/dwf08f0443/images/lacoste.svg"
              width={104}
            ></img>
          </div>
          <div>
            <img
              src="https://imagedeleg1.lacoste.com/dw/image/v2/BGSW_PRD/on/demandware.static/Sites-ID-Site/-/default/dwa95bf943/images/crocodile.svg"
              width={38}
            ></img>
          </div>
        </div>
        <div className="flex gap-7">
          <span className="flex">
            <span
              ...
              onClick={() => toggleMenu("manUl")}
            >
              Men
              <ul
                id="manUl"
                className="absolute bg-slate-50 p-3 rounded-2xl"
                style={{ display: "none" }}
              >
          ...
          <span className="flex">
            <span className="self-start">Women</span>
            <span class="material-symbols-outlined">expand_more</span>
          </span>
          <span className="flex">
            <span className="self-start">Kid</span>
            <span class="material-symbols-outlined">expand_more</span>
          </span>
          <span className="flex">
            <span className="self-start">Polo</span>
            <span class="material-symbols-outlined">expand_more</span>
          </span>
          <span className="flex">
            <span className="self-start">Collection</span>
            <span class="material-symbols-outlined">expand_more</span>
          </span>
          <span className="flex">
            <span className="self-start">We are Lacoste</span>
            <span class="material-symbols-outlined">expand_more</span>
          </span>
          <div>
      ...
      <footer className="h-full">
        ...
        <div className="h-[458px] bg-gray-100 flex justify-around items-center">
          <div>
            <div>
              <strong>Sign up for new stories,</strong>
              <br />
